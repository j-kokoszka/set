                ...
                <ResponsiveContainer>
                  <PieChart>
                    <Pie
                      ...
                      label={(props: any) => `${(Number(props.percent || 0) * 100).toFixed(0)}%`}
                    >
                    ...
                    {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                    <Tooltip formatter={(value: any, name: any, props: any) => [`${value}kg (${(Number(props.payload.percent || 0) * 100).toFixed(0)}%)`, name]} />
                    <Legend />
                  </PieChart>
                </ResponsiveContainer>
              </div>
